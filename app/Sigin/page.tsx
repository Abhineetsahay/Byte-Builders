      ...
      <Card className="w-full max-w-md bg-white shadow-lg">
        <CardHeader className="space-y-6 pb-6">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800">Welcome to Mo Sahara</h1>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Select value={selectedState} onValueChange={handleStateChange}>
              <SelectTrigger className="h-12 text-gray-600">
          ...
          <Button variant="outline" className="w-full h-12 bg-white border-gray-300 text-gray-800 hover:bg-gray-50">
            Login In
          </Button>
